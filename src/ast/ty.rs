...
pub enum PrimitiveType {
    ...
    #[casing(Lower)] DMat3,
    #[casing(Lower)] DMat4,
    #[casing(Lower)] DMat2x3,
    #[casing(Lower)] DMat2x4,
    #[casing(Lower)] DMat3x2,
    #[casing(Lower)] DMat3x4,
    #[casing(Lower)] DMat4x2,
    #[casing(Lower)] DMat4x3,
}
