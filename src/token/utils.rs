...
macro_rules! T {
    ...
    (fn) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Fn) };
    (struct) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Struct) };
    (if) => { $crate::token::TokenType::Keyword($crate::token::Keyword::If) };
    (else) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Else) };
    (while) => { $crate::token::TokenType::Keyword($crate::token::Keyword::While) };
    (for) => { $crate::token::TokenType::Keyword($crate::token::Keyword::For) };
    (return) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Return) };
    (let) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Let) };
    (include) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Include) };
    (extension) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Extension) };
    (enable) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Enable) };
    (require) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Require) };
    (warn) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Warn) };
    (disable) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Disable) };
    (input) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Input) };
    (output) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Output) };
    (provide) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Provide) };
    (push_constants) => { $crate::token::TokenType::Keyword($crate::token::Keyword::PushConstants) };
    (uniform) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Uniform) };
    (buffer) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Buffer) };
    (std430) => { $crate::token::TokenType::Keyword($crate::token::Keyword::STD430) };
    (std140) => { $crate::token::TokenType::Keyword($crate::token::Keyword::STD140) };
    (readonly) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Readonly) };
    (writeonly) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Writeonly) };
    (break) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Break) };
    (continue) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Continue) };
    (flat) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Flat) };
    (smooth) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Smooth) };
    (noperspective) => { $crate::token::TokenType::Keyword($crate::token::Keyword::Noperspective) };
